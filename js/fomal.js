...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Sky☁")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'LACBZ-Z3XK4-JE5UB-K5R66-XH6NK-WTBEG',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.10375415183535, 23.047445623569033, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("02/01/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
  ...
  var ascll = [
    `欢迎来到RoHananのSky☁!`,
    `A spark of wonder in the everyday.🎇🎇🎇`,
    `
    ██████╗  ██████╗ ██╗  ██╗ █████╗ ███╗   ██╗ █████╗ ███╗   ██╗
    ██╔══██╗██╔═══██╗██║  ██║██╔══██╗████╗  ██║██╔══██╗████╗  ██║
    ██████╔╝██║   ██║███████║███████║██╔██╗ ██║███████║██╔██╗ ██║
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c Powered by Rohanan %c 你正在访问RoHananのSky☁",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Sky☁") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Sky☁的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = '啊！(,,•́Д•̀,,)坏掉了';
    clearTimeout(titleTime);
  } else {
    //返回当前页面时标签显示内容
    document.title = 'Ciallo～(∠・ω༨ )⌒★';
    //两秒后变回正常标题
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("02/01/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/Sky-🎮Playing GalGames-blue?style=social&logo=data:image/png;base64,' title='在认真摸鱼辣~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/Sky-🦌倒灌大王已上线-blue?style=social&logo=data:image/png;base64,' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`),
...
if (localStorage.getItem("font") == undefined) {
  localStorage.setItem("font", "HONORSansCN");
}
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://img.qwqsky.top/background/92817067_p0_master1200.jpg);
    --darkmode-bg: url(https://img.qwqsky.top/background/92968709_p0_master1200.webp);
    --mobileday-bg: url(https://img.qwqsky.top/background/92817067_p0_master1200.jpg);
    --mobilenight-bg: url(https://img.qwqsky.top/background/92968709_p0_master1200.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<a class="swf" id="swf_HONORSansCN-Regular" href="javascript:;" rel="noopener external nofollow" style="font-family:'HONORSansCN-Regular'!important;color:black" onclick="setFont('HONORSansCN-Regular')">HONORSans</a>
