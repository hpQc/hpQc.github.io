...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    ...
    --darkmode-bg: url(https://img.qwqsky.top/background/92968709_p0_master1200.jpg);
    --mobileday-bg: url(https://img.qwqsky.top/background/92817067_p0_master1200.jpg);
    --mobilenight-bg: url(https://img.qwqsky.top/background/92968709_p0_master1200.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
